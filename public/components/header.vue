...
<!--      </div>-->
      ...
      <div class="hidden lg:flex justify-between w-full max-w-3xl">
        ...
        <div class="text-lg text-gray-700 flex relative cursor-pointer" @click="router.push('/banking')">
          e-banking
        </div>
<!--        <div class="text-sm text-gray-700 flex relative">-->
...
<!--                    stroke-linejoin="round">-->
<!--                <path d="M9 9l6 8l7 -8" />-->
<!--&lt;!&ndash;                <path v-if="close3" d="M9 18l6 -8l7 8" />&ndash;&gt;-->
<!--              </svg>-->
<!--              <span class="absolute bottom-0 left-0 w-0 h-px bg-primary transition-all duration-500 group-hover:w-full"></span>-->
<!--            </h2>-->
<!--          </div>-->
...
<!--    <div class="absolute text-xl font-bold text-blue-600 cursor-pointer h-[4rem] w-[4rem] z-50" @click="router.push('/')">-->
<!--      <img :src="logo" alt="Logo" class="object-scale-down">-->
<!--    </div>-->
<!--    <div></div>-->
