...
import {IconMoneybagPlus, IconScriptPlus, IconCurrencyDollar, IconBrandWhatsapp} from '@tabler/icons-vue';
...
onMounted(() => {
  ...
  // Animations pour la collecte journaliere
  ScrollTrigger.create({
...
<template>
  <div class="flex flex-col min-h-screen">
    ...
    <section class="relative h-screen overflow-hidden hidden">
    ...
    <div id="section5" class="bg-primary lg:px-16 px-8 py-12">
      <div class="container mx-auto description-text">
        ...
        <!--                 class="w-full object-cover">-->
        <!--            <div class="p-6">-->
        <!--              <h3 class="text-lg montserrat montserrat-600 text-primary mb-2">Minimum d’épargne</h3>-->
        <!--              <p class="text-gray-600 montserrat montserrat-400 mb-4">200 XAF/jour</p>-->
        <!--            </div>-->
        <!--          </div>-->
        <!--          <div-->
        <!--              class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105">-->
        ...
        <!--                 class="w-full object-cover">-->
        <!--            <div class="p-6">-->
        <!--              <p class="text-xl font-bold mb-2">Disponible au décaissement</p>-->
...
<!--&lt;!&ndash; Section Formulaire de Contact modifiée &ndash;&gt;-->
<!--<template>-->
<!--  <div>-->
<!--    <Header />-->
<!--    <main>-->
<!--      &lt;!&ndash; Section Formulaire de Contact &ndash;&gt;-->
